...
namespace SJLInvEntity
{
    ...
    public partial class SJLInvEntities : DbContext
    {
        public SJLInvEntities()
            : base("name=SJLInvEntities")
        {
        }
        ...
        public virtual DbSet<Im_CurrentStock13Apr17> Im_CurrentStock13Apr17 { get; set; }
        public virtual DbSet<Im_CurrentStock22Apr17> Im_CurrentStock22Apr17 { get; set; }
        public virtual DbSet<IM_CurrentStockwithPinData> IM_CurrentStockwithPinData { get; set; }
        ...
        public virtual DbSet<M_LedgerMaster_Old> M_LedgerMaster_Old { get; set; }
        public virtual DbSet<M_LedgerMAsterPartyCode> M_LedgerMAsterPartyCode { get; set; }
        ...
        public virtual DbSet<TrnBillData22Apr17> TrnBillData22Apr17 { get; set; }
        public virtual DbSet<TrnBillDetails22Apr17> TrnBillDetails22Apr17 { get; set; }
        public virtual DbSet<TrnBillMain22Apr17> TrnBillMain22Apr17 { get; set; }
        ...
        public virtual DbSet<TrnProductDispatchDetail22Apr17> TrnProductDispatchDetail22Apr17 { get; set; }
        ...
        public virtual DbSet<TrnVoucher22Apr17> TrnVoucher22Apr17 { get; set; }
        ...
        [DbFunction("SJLInvEntities", "Sample")]
        public virtual IQueryable<Sample_Result> Sample(Nullable<int> sampleValue)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Sample_Result>("[SJLInvEntities].[Sample](@SampleValue)", sampleValueParameter);
        }
        ...
        public virtual int DispatchOrder(Nullable<decimal> orderNo, string soldBy)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DispatchOrder", orderNoParameter, soldByParameter);
        }
    
        public virtual ObjectResult<GetLogin_Result> GetLogin(string userName, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetLogin_Result>("GetLogin", userNameParameter, passwordParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> UpdatePassword(string userName, string currentPassword, string newPassword)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("UpdatePassword", userNameParameter, currentPasswordParameter, newPasswordParameter);
        }
    }
}
