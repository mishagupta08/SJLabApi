...
namespace SJLabEntity
{
    ...
    public partial class sp_MemDtl_Result
    {
        ...
        public string IsPinPoint { get; set; }
        public string IdProof { get; set; }
        public System.DateTime IdProofDate { get; set; }
        public string AddrProof { get; set; }
        public System.DateTime AddrProofDate { get; set; }
        public string IsIdVerified { get; set; }
        public string IsAddrssVerified { get; set; }
        ...
        public Nullable<decimal> RefId1 { get; set; }
        public string RefIDNo { get; set; }
        public string UpLnName { get; set; }
        public Nullable<decimal> UpLnId { get; set; }
        public string UpLnIDNo { get; set; }
        public string Category { get; set; }
        public string MemLegNo { get; set; }
    }
}
